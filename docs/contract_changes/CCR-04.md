...
Status: approved (@k, 23 Sep 2026); part 1 landed (@k, 139a600); part 2 landed on b4-governance in B4.3 (field + fill + test; make types as a separable integrator-owned commit)
